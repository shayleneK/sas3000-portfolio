...
jQuery(function () {
    ...
    var texts = [
        ...
        "MultiPest Corporation Dashboard"
    ]
    ...
    var links = [
        ...
        "https://github.com/gitnadu/STSWENG"
    ]
    ...
    var descriptions = [
        ...
        "A concert management system allowing the operation of concert venues, concert, and tickets. A project experimenting the functions and implementation of the SQL database.",
        ...
        "An online dashboard for MultiPest Corporation. As the designer of the project, I mainly handled the Figma Implementation and FrontEnd Development of the website."
    ]
    ...
    var projectTags = [
        ...
        ["Python"],
        ["HTML", "CSS", "Handlebars"],
        ["Next.Js", "TailwindCSS", "TypeScript", "Cypress"]
    ]
